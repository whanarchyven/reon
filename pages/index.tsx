...
const Home: NextPage = () => {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>REON - FIRST NFT FANTASY VIDEOGAME</title>
        ...
        <link rel="icon" href="/favicon.ico" />
          ...
          <link
              rel="preload"
              href="/images/bg_3.png"
              as="image"
              crossOrigin=""
          />
          <link
              rel="preload"
              href="/images/bg_4.png"
              as="image"
              crossOrigin=""
          />
          <link
              rel="preload"
              href="/images/bg_5.png"
              as="image"
              crossOrigin=""
          />
          <link
              rel="preload"
              href="/images/bg_6.png"
              as="image"
              crossOrigin=""
          />
          <link
              rel="preload"
              href="/images/bg_7.png"
              as="image"
              crossOrigin=""
          />
          <link
              rel="preload"
              href="/images/bg_8.png"
              as="image"
              crossOrigin=""
          />
          <link
              rel="preload"
              href="/images/bg_9.png"
              as="image"
              crossOrigin=""
          />
          <link
              rel="preload"
              href="/images/bg_10.png"
              as="image"
              crossOrigin=""
          />
          <link
              rel="preload"
              href="/images/bg_11.png"
              as="image"
              crossOrigin=""
          />
          <link
              rel="preload"
              href="/images/bg_12.png"
              as="image"
              crossOrigin=""
          />
          <link
              rel="preload"
              href="/images/bg_13.png"
              as="image"
              crossOrigin=""
          />
          <link
              rel="preload"
              href="/images/bg_map.png"
              as="image"
              crossOrigin=""
          />
          <link
              rel="preload"
              href="/images/arrow_horizontal.svg"
              as="image"
              crossOrigin=""
          />
          <link
              rel="preload"
              href="/images/arrow_vertical.svg"
              as="image"
              crossOrigin=""
          />
          <link
              rel="preload"
              href="/images/elf_race.png"
              as="image"
              crossOrigin=""
          />
          <link
              rel="preload"
              href="/images/orc_race.png"
              as="image"
              crossOrigin=""
          />
          <link
              rel="preload"
              href="/images/dwarf_race.png"
              as="image"
              crossOrigin=""
          />
          <link
              rel="preload"
              href="/images/elf_race_blured.png"
              as="image"
              crossOrigin=""
          />
          <link
              rel="preload"
              href="/images/orc_race_blured.png"
              as="image"
              crossOrigin=""
          />
          <link
              rel="preload"
              href="/images/dwarf_race_blured.png"
              as="image"
              crossOrigin=""
          />
          <link
              rel="preload"
              href="/images/background.mp4"
              as="video"
              crossOrigin=""
          />
          <link
              rel="preload"
              href="/images/navbar_uzor.png"
              as="image"
              crossOrigin=""
          />
          <link
              rel="preload"
              href="/images/reon_logo.png"
              as="image"
              crossOrigin=""
          />
          <link
              rel="preload"
              href="/images/twitter_button.png"
              as="image"
              crossOrigin=""
          />
          <link
              rel="preload"
              href="/images/telegram_button.png"
              as="image"
              crossOrigin=""
          />
          <link
              rel="preload"
              href="/images/mail_button.png"
              as="image"
              crossOrigin=""
          />
      </Head>
