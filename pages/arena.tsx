...
import * as SpinePlayer from '@esotericsoftware/spine-player';
  ...
  return (
      ...
      <main className={styles.main}>
          ...
          <div className={' block bg-cover text-[10px] sm:text-[25px] lg:text-[30px] bg-[url(../public/images/coming_soon.png)] relative w-[100vw] h-[58vw]'}>
              ...
              }}><h1 className={'absolute inline-block left-[36vw] top-[4vw] text-reon text-[6.2vw] font-title'}>ARENA</h1></motion.div>
